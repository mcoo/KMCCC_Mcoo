...
namespace KMCCC.Authentication
{
    ...
    public class YggdrasilLogin : IAuthenticator
    {
        ...
        /// <param name="LauncherToken">LauncherToken</param>
        /// <param name="authServer">验证服务器</param>
        public YggdrasilLogin(string email, string password, bool twitchEnabled, Guid clientToken,string launcherToken, string token = null, string authServer = null)
        {
            Email = email;
            Password = password;
        ...
        public YggdrasilLogin(string email, string password, bool twitchEnabled, string launcherToken, string token = null, string authServer = null)
        {
            Email = email;
            Password = password;
            TwitchEnabled = twitchEnabled;
        ...
        ///     LauncherToken
        /// </summary>
        public string LauncherToken { get; }
        /// <summary>
        ///     是否启用Twitch
        /// </summary>
        ...
        {
            var client = new YggdrasilClient(AuthServer, ClientToken);
            return client.AuthenticateAsync(Email, Password,LauncherToken, Token, TwitchEnabled, token).ContinueWith(task =>
            {
